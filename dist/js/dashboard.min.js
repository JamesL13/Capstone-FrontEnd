...
function CreateAccountCtrl(r,o,a){var t="https://thomasscully.com";r.formErrors=!1,r.formErrorMessage="",r.submit=function(a){a?(r.formErrors=!1,o.post(t+"/accounts",r.accountInfo).then(successCallback,errorCallback)):(r.formErrors=!0,r.formErrorMessage="Invalid form input. Please try again.")},successCallback=function(o){console.log(o),"Email already in use.  Cannot create account."==o.data?(r.formErrorMessage=o.data,r.formErrors=!0):(a.put("isLoggedIn",!0),a.put("userId",o.data),window.location="#/host")},errorCallback=function(o){r.formErrors=!0};var c=function(){};c()}angular.module("Songs").controller("CreateAccountCtrl",["$scope","$http","$cookieStore",CreateAccountCtrl]);
function FindHostCtrl(o,n,s){var e="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,n.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var t=function(n){1==n?($cookieStore.put("isConnected",!0),$cookieStore.put("jukeBoxid",o.currentId),console.log("success and true"),null!=o.modalInstance&&(o.modalInstance.$dismiss(connect),console.log("success true and modal not null"))):(o.formErrorMessage="Invalid password.",o.formErrors=!0,console.log("success false"))},l=function(o){console.log(o)},r=function(){n.get(e+"/playlists").success(function(n){o.jukeboxes=n}).then(t,l)};o.open=function(n,e){console.log(e),o.currentId=e,o.modalInstance=s.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:n,scope:o})},o.submit=function(){var s=!0;s?(n.post(e+"/playlists/join",{id:o.currentId,password:"thomas"}).then(t,l),console.log("submit and isvalid")):(o.formErrors=!0,o.formErrorMessage="Invalid password.",console.log("submit and invalid"))},r()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
function HostCtrl(o,t,e){var s="https://thomasscully.com";o.formErrors=!1,o.formErrorMessage="",o.userId=e.get("userId"),o.manageAccount=function(){window.location="#/manageaccount"},o.manageJukebox=function(){window.location="#/managejukebox"},o.deletePlaylist=function(){var e=confirm("Are you sure you'd like to delete this playlist?");1==e&&t["delete"](s+"/playlists?id="+o.playlist_id).then(function(o){location.reload()},function(o){console.log("Server did not successfully complete request.")})},o.submit=function(e){if(e){var a={user__account:o.userId,playlist_name:o.loginDetails.playlist_name,description:o.loginDetails.description,password:o.loginDetails.password};t.post(s+"/playlists",a).then(function(o){location.reload()},function(o){console.log("Server did not successfully complete request.")})}else o.formErrors=!0,o.formErrorMessage="There was a problem with your input. Please try again."};var a=function(t){""==t.data?o.hasPlaylist=!1:(o.hasPlaylist=!0,o.playlist_id=t.data[0].id,o.playlist_name=t.data[0].playlist_name,o.description=t.data[0].description,o.password=t.data[0].password)},l=function(o){},n=function(){e.get("isLoggedIn")||(window.location="#/login"),t.get(s+"/playlists?account__id="+e.get("userId")).then(a,l)};n()}angular.module("Songs").controller("HostCtrl",["$scope","$http","$cookieStore",HostCtrl]);
function LoginCtrl(r,o,s){var n="https://thomasscully.com";r.formErrors=!1,r.formErrorMessage="",r.submit=function(s){s?o.post(n+"/accounts/login",r.loginDetails).then(t,a):(r.formErrors=!0,r.formErrorMessage="Invalid username / password.")};var t=function(o){o.data?(s.put("isLoggedIn",!0),s.put("userId",o.data),window.location="#/host"):(r.formErrorMessage="Invalid username / password combination.",r.formErrors=!0)},a=function(o){r.formErrorMessage="Server not responding. Please try again later.",r.formErrors=!0}}angular.module("Songs").controller("LoginCtrl",["$scope","$http","$cookieStore",LoginCtrl]);
function ManageAccountCtrl(n,o,t){n.cancel=function(){window.location="#/host"},n.saveChanges=function(){};var c=function(){t.get("isLoggedIn")||(window.location="#/login")};c()}angular.module("Songs").controller("ManageAccountCtrl",["$scope","$http","$cookieStore",ManageAccountCtrl]);
function ManageJukeboxCtrl(t,e,n){var o="https://thomasscully.com";t.cancel=function(){window.location="#/host"},t.saveChanges=function(){};var a=[],l=[],s=[],c=[],u=[],r=[],g=[],d=[],f=function(){l=[],s=[],c=[],u=[],r=[],g=[]};t.upload=function(){document.getElementById("upload").disabled=!0,f(),h()};var h=function(){for(i=0;i<a.length;i++){var t=document.createElement("audio");t.setAttribute("id",i);var e=URL.createObjectURL(a[i]);r[i]=e,t.setAttribute("src",e),t.load(),t.oncanplaythrough=function(){u[this.id]=this.duration,m(this.id,b)}}},m=function(t,e){var n=a[t];new jsmediatags.Reader(n).setTagsToRead(["title","album","artist"]).read({onSuccess:function(n){l[t]=n.tags.title,s[t]=n.tags.artist,c[t]=n.tags.album,e(t)},onError:function(t){console.log(t)}})},b=function(t){g.push({song_title:l[t],song_artist:s[t],song_album:c[t],song_length:u[t],location_in_filesystem:r[t]}),d[t]=!0,v(),v()&&p()},p=function(){console.log(g);var t={user_account_id:2,number_of_songs:g.length,songs:g};console.log(t),e.post(o+"/songs",t).then(successCallback,errorCallback),document.getElementById("fileinput").value="",a=[]},v=function(){for(i=0;i<d.length;i++)if(!d[i])return!1;return!0};successCallback=function(t){console.log("SUCCESS: "+t)},errorCallback=function(t){console.dir(t)};var C=document.getElementById("fileinput");C.addEventListener("change",function(t){for(a=[],d=[],i=0;i<t.target.files.length;i++){var e=t.target.files[i];a.push(e),d[i]=!1}document.getElementById("upload").disabled=!1},!1)}angular.module("Songs").controller("ManageJukeboxCtrl",["$scope","$http","$cookieStore",ManageJukeboxCtrl]);
