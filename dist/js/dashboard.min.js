...
function FindHostCtrl(e,o,n,t,s){var a="https://thomasscully.com";e.modalInstance=null,e.animationsEnabled=!0,e.formErrors=!1,e.formErrorMessage="",e.currentId=null,e.hostId=null,o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},e.jukeboxes=[];var l=function(e){console.log("failure"),console.log(e)},r=function(o){null!=e.modalInstance&&(0==o.data?(e.formErrorMessage="Invalid password.",e.formErrors=!0):(isConnectedChecker=t.get("isConnectedToPlaylist"),(isConnectedChecker=!0)&&(t.put("jukeBoxid",e.currentId),t.put("hostid",e.hostId)),t.put("isConnectedToPlaylist",!0),t.put("connectPlaylistUserId",o.data),e.modalInstance.dismiss(),window.location="#/jukebox"))},i=function(e){},c=function(){o.get(a+"/playlists").success(function(o){e.jukeboxes=o,$(".spinner").addClass("hide")}).then(i,l)};e.open=function(o,t,s){e.hostId=t,e.currentId=s,e.modalInstance=n.open({animation:e.animationsEnabled,templateUrl:"templates/modalContent.html",size:o,scope:e,id:s})},e.submit=function(n,t,s){if(n){var i=e.currentId.toString();e.playlistname=s;var c={id:i,password:t.$modelValue};o.post(a+"/playlists/join",c).then(r,l)}else e.formErrors=!0,e.formErrorMessage="Enter Password"},c(),e.$on("hostSearchAttempted",function(o,n){var t=s.getAllJukeboxes();console.log(t),t.length>0?(e.jukeboxes=[],e.jukeboxes=t):(e.jukeboxes=[],$("#no-songs-message").removeClass("hide"))})}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore","searchApp",FindHostCtrl]);
...
function LibraryCtrl(n,o,e,s){var t="https://thomasscully.com";o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},n.addSongToJukebox=function(n){var e=$("#increaseButtonInner_"+n);e.html('<img src="img/default.gif" height="9px" width="9px" />'),e.addClass("disabled");var s={action:"in",id:n};o.put(t+"/toggle/song",s).success(function(o){$("#increaseButton_"+n).html('<br><button disabled type="button" id="increaseButton_{{song.id}}" class="btn btn-warning">+</button>')}).error(function(n){console.log(n)})};var i=function(o){$(".spinner").addClass("hide"),o.data.songs.length>0?n.songs=o.data.songs:$("#no-songs-message").removeClass("hide")},a=function(n){console.log("Error:"),console.log(n)},l=function(){$(".spinner").removeClass("hide"),void 0!=e.get("isConnectedToPlaylist")&&e.get("isConnectedToPlaylist")?o.get(t+"/songs?user_account_id="+e.get("connectPlaylistUserId")).then(i,a):window.location="#/findhost"};l(),n.$on("searchAttempted",function(o,e){var t=s.getAllSongs();console.log(t),t.length>0?(n.songs=[],n.songs=t):(n.songs=[],$("#no-songs-message").removeClass("hide"))})}angular.module("Songs").controller("LibraryCtrl",["$scope","$http","$cookieStore","searchApp",LibraryCtrl]);
...
function searchApp(o,e,t){var n="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var a=[],s=[],r=function(e){e.data.songs.length>0&&(a=[],e.data.songs.forEach(function(e){e.song_title.search(o.searchFor)>-1?a.push(e):console.log("Song is not going to be returned")})),o.$broadcast("searchAttempted",{myParam:o.songs})},c=function(o){console.log("Error:"),console.log(o)},l=function(e){console.log(e),e.data.length>0&&(s=[],e.data.forEach(function(e){e.playlist_name.search(o.searchFor)>-1?s.push(e):console.log("Host is not going to be returned")})),o.$broadcast("hostSearchAttempted",{myParam:o.songs})};return{findWhatToSearch:function(a,s){o.searchFor=s;var h=e.absUrl();h.search("library")>-1||h.search("jukebox")>-1?t.get(n+"/songs?user_account_id="+a).then(r,c):h.search("findhost")?t.get(n+"/playlists").then(l,c):alert("Hi")},getAllSongs:function(){return a},getAllJukeboxes:function(){return s}}}angular.module("Songs").service("searchApp",["$rootScope","$location","$http",searchApp]);
