...
function FindHostCtrl(o,t){var n="https://thomasscully.com";o.jukeboxes=[];var s=function(o){console.log(o)},l=function(o){console.log(o)},c=function(){console.log("submitting"),t.get(n+"/playlists").success(function(t){o.jukeboxes=t}).then(s,l)};c()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$cookieStore",FindHostCtrl]);
