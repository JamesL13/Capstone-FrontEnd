...
function ManageJukeboxCtrl(t,e,a){t.cancel=function(){window.location="#/host"},t.saveChanges=function(){};var n=document.getElementById("fileinput");n.addEventListener("change",function(t){for(i=0;i<t.target.files.length;i++){var e=t.target.files[i];jsmediatags.read(e,{onSuccess:function(t){var a=document.getElementById("song"),n=URL.createObjectURL(e);a.src=n,a.load(),a.addEventListener("loadedmetadata",function(){var e={title:t.tags.title,artist:t.tags.artist,album:t.tags.album,duration:a.duration};console.log(e),alert(e.title+","+e.artist+","+e.album+","+e.duration/60+":"+e.duration%60)})},onError:function(t){alert(t),console.log(t)}})}},!1)}angular.module("Songs").controller("ManageJukeboxCtrl",["$scope","$http","$cookieStore",ManageJukeboxCtrl]);
