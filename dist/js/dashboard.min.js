...
function FindHostCtrl(o,n,e){var s="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,n.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var t=function(n){1==n?($cookieStore.put("isConnected",!0),$cookieStore.put("jukeBoxid",o.currentId),null!=o.modalInstance&&o.modalInstance.$dismiss(connect)):(o.formErrorMessage="Invalid password.",o.formErrors=!0),null!=o.modalInstance&&o.modalInstance.$dismiss(connect)},r=function(o){console.log(o)},a=function(){n.get(s+"/playlists").success(function(n){o.jukeboxes=n}).then(t,r)};o.open=function(n,s){console.log(s),o.currentId=s,o.modalInstance=e.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:n,scope:o})},o.submit=function(e){console.log(o.password),e?n.post(s+"/playlists/join",{id:o.currentId,password:"password"}).then(t,r):(o.formErrors=!0,o.formErrorMessage="Invalid password.")},a()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
