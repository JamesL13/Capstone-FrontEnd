...
function FindHostCtrl(o,e,n,t){var s="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var a=function(o){console.log("failure"),console.log(o)},l=function(e){null!=o.modalInstance&&(0==e.data?(o.formErrorMessage="Invalid password.",o.formErrors=!0):(isConnectedChecker=t.get("isConnectedToPlaylist"),(isConnectedChecker=!0)&&t.put("connectPlaylistUserId",""),socket.emit("room",o.playlistname),t.put("isConnectedToPlaylist",!0),t.put("connectPlaylistUserId",e.data),o.modalInstance.dismiss(),window.location="#/jukebox"))},r=function(o){},i=function(){e.get(s+"/playlists").success(function(e){o.jukeboxes=e}).then(r,a)};o.open=function(e,t){o.currentId=t,o.modalInstance=n.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:e,scope:o,id:t})},o.submit=function(n,t,r){if(n){var i=o.currentId.toString();o.playlistname=r;var c={id:i,password:t.$modelValue};e.post(s+"/playlists/join",c).then(l,a)}else o.formErrors=!0,o.formErrorMessage="Enter Password"},i()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
...
function JukeboxCtrl(o,e,t){e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var n=function(){void 0!=t.get("isConnectedToPlaylist")&&t.get("isConnectedToPlaylist")||(window.location="#/findhost")};n()}angular.module("Songs").controller("JukeboxCtrl",["$scope","$http","$cookieStore",JukeboxCtrl]);
