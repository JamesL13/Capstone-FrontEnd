...
function FindHostCtrl(o,t,n,e){var s="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,o.hostId=null,t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var r=function(o){console.log("failure"),console.log(o)},l=function(t){null!=o.modalInstance&&(0==t.data?(o.formErrorMessage="Invalid password.",o.formErrors=!0):(isConnectedChecker=e.get("isConnectedToPlaylist"),(isConnectedChecker=!0)&&(e.put("jukeBoxid",o.currentId),e.put("hostid",o.hostId)),e.put("isConnectedToPlaylist",!0),e.put("jukeBoxid",o.currentId),e.put("hostid",o.hostId),o.modalInstance.dismiss(),window.location="#/jukebox"))},i=function(o){},a=function(){t.get(s+"/playlists").success(function(t){o.jukeboxes=t}).then(i,r)};o.open=function(t,e,s){o.hostId=e,o.currentId=s,o.modalInstance=n.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:t,scope:o,id:s})},o.submit=function(n,e){if(n){var i=o.currentId.toString(),a={id:i,password:e.$modelValue};t.post(s+"/playlists/join",a).then(l,r)}else o.formErrors=!0,o.formErrorMessage="Enter Password"},a()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
function HostCtrl(t,e,o){var s="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},t.formErrors=!1,t.formErrorMessage="",t.userId=o.get("userId"),t.manageAccount=function(){window.location="#/manageaccount"},t.deletePlaylist=function(){var o=confirm("Are you sure you'd like to delete this playlist?");1==o&&e["delete"](s+"/playlists?id="+t.playlist_id).then(function(t){location.reload()},function(t){console.log("Server did not successfully complete request.")})},t.submit=function(o){if(o){var n={user__account:t.userId,playlist_name:t.loginDetails.playlist_name,description:t.loginDetails.description,password:t.loginDetails.password};e.post(s+"/playlists",n).then(function(t){location.reload()},function(t){console.log("Server did not successfully complete request.")})}else t.formErrors=!0,t.formErrorMessage="There was a problem with your input. Please try again."};var n=function(t,e){for(var o=0,s=t.length;s>o;o+=1)if(t[o].id===e)return t[o]},a=function(e){""==e.data?t.hasPlaylist=!1:(t.hasPlaylist=!0,t.playlist_id=e.data[0].id,t.playlist_name=e.data[0].playlist_name,t.description=e.data[0].description,t.password=e.data[0].password)},i=function(e){var s=o.get("userId"),a=n(e.data,s);t.businessName=a.business},l=function(t){console.log("Something went wrong.")},r=function(){o.get("isLoggedIn")||(window.location="#/login"),e.get(s+"/playlists?account__id="+o.get("userId")).then(a,l),e.get(s+"/accounts?account__id="+o.get("userId")).then(i,l)};r()}angular.module("Songs").controller("HostCtrl",["$scope","$http","$cookieStore",HostCtrl]);
...
function LibraryCtrl(o,t,e){t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var n=function(){void 0!=e.get("isConnectedToPlaylist")&&e.get("isConnectedToPlaylist")||(window.location="#/findhost")};n()}angular.module("Songs").controller("LibraryCtrl",["$scope","$http","$cookieStore",LibraryCtrl]);
