...
function FindHostCtrl(o,t){var n="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var e=function(o){console.log(o)},s=function(o){console.log(o)},c=function(){console.log("submitting"),t.get(n+"/playlists").success(function(t){o.jukeboxes=t}).then(e,s)};c()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$cookieStore",FindHostCtrl]);
...
function MasterCtrl(t,g){var o=992;t.greeting="Hola!",t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(e,n){e>=o?angular.isDefined(g.get("toggle"))?t.toggle=g.get("toggle")?!0:!1:t.toggle=!0:t.toggle=!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,g.put("toggle",t.toggle)},window.onresize=function(){t.$apply()},t.logout=function(){g.put("isLoggedIn",!1)},t.$on("$locationChangeStart",function(o){t.isLoggedIn=g.get("isLoggedIn")})}angular.module("Songs").controller("MasterCtrl",["$scope","$cookieStore",MasterCtrl]);
