...
"use strict";angular.module("Songs").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/jukebox.html"}).state("findHost",{url:"/findhost",templateUrl:"templates/findHost.html"}).state("libary",{url:"/libary",templateUrl:"templates/library.html"}).state("login",{url:"/login",templateUrl:"templates/login.html"}).state("createaccount",{url:"/createaccount",templateUrl:"templates/createaccount.html"}).state("host",{url:"/host",templateUrl:"templates/host.html"}).state("manageaccount",{url:"/manageaccount",templateUrl:"templates/manageAccount.html"}).state("managejukebox",{url:"/managejukebox",templateUrl:"templates/manageJukebox.html"})}]);
...
function FindHostCtrl(o,t){var e="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var n=function(o){},s=function(o){console.log(o)},c=function(){t.get(e+"/playlists").success(function(t){o.jukeboxes=t}).then(n,s)};c()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$cookieStore",FindHostCtrl]);
