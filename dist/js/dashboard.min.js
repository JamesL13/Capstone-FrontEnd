...
function FindHostCtrl(o,e,n){var t="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var r=function(e){console.log(e),null!=o.modalInstance&&(1==e?(isConnectedChecker=$cookieStore.get("isConnected"),(isConnectedChecker=!0)&&($cookieStore.put("jukeBoxid",""),$cookieStore.put("jukeBoxid",o.currentId)),$cookieStore.put("isConnected",!0),$cookieStore.put("jukeBoxid",o.currentId),o.modalInstance.dismiss()):(o.formErrorMessage="Invalid password.",o.formErrors=!0))},s=function(o){console.log(o)},i=function(){e.get(t+"/playlists").success(function(e){o.jukeboxes=e}).then(r,s)};o.open=function(e,t){o.currentId=t,o.modalInstance=n.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:e,scope:o,id:t})},o.submit=function(n,i){n?e.post(t+"/playlists/join",{id:o.currentId,password:i}).then(r,s):(o.formErrors=!0,o.formErrorMessage="Enter Password")},i()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
