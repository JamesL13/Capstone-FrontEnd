...
function JukeboxCtrl(o,e,n){var t="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var s=n.get("hostid");o.businessName,o.playlistName;var c=function(e){$(".spinner").hide(),e.data.songs.length>0?o.songs=e.data.songs:$("#no-songs-message").removeClass("hide")},l=function(o){console.log("Error:"),console.log(o)},i=function(){void 0!=n.get("isConnectedToPlaylist")&&n.get("isConnectedToPlaylist")||(window.location="#/findhost"),e.get(t+"/accounts?account__id="+s).success(function(e){console.log(e),o.businessName=e[0]}).then(a,l),e.get(t+"/playlists?account__id="+s).success(function(e){o.playlistName=e[0]}).then(a,l),e.get(t+"/songs/active?user_account_id="+n.get("connectPlaylistUserId")).then(c,l)},l=function(o){console.log("failure"),console.log(o)},a=function(o){};i()}angular.module("Songs").controller("JukeboxCtrl",["$scope","$http","$cookieStore",JukeboxCtrl]);
