angular.module("Songs",["ui.bootstrap","ui.router","ngCookies"]);
"use strict";angular.module("Songs").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/jukebox.html"}).state("findHost",{url:"/findhost",templateUrl:"templates/findHost.html"}).state("library",{url:"/library",templateUrl:"templates/library.html"}).state("jukebox",{url:"/jukebox",templateUrl:"templates/jukebox.html"}).state("login",{url:"/login",templateUrl:"templates/login.html"}).state("createaccount",{url:"/createaccount",templateUrl:"templates/createaccount.html"}).state("host",{url:"/host",templateUrl:"templates/host.html"}).state("manageaccount",{url:"/manageaccount",templateUrl:"templates/manageAccount.html"}).state("managejukebox",{url:"/managejukebox",templateUrl:"templates/manageJukebox.html"})}]);
var socket=io("https://thomasscully.com");
function AlertsCtrl(l){l.alerts=[{type:"success",msg:"Welcome to Song[s]!"}],l.closeAlert=function(e){l.alerts.splice(e,1)}}angular.module("Songs").controller("AlertsCtrl",["$scope",AlertsCtrl]);
function CreateAccountCtrl(r,o,t){var a="https://thomasscully.com";o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},r.formErrors=!1,r.formErrorMessage="",r.submit=function(t){t?(r.formErrors=!1,o.post(a+"/accounts",r.accountInfo).then(successCallback,errorCallback)):(r.formErrors=!0,r.formErrorMessage="Invalid form input. Please try again.")},successCallback=function(o){"Email already in use.  Cannot create account."==o.data?(r.formErrorMessage=o.data,r.formErrors=!0):window.location="#/login?account_creation=true"},errorCallback=function(o){r.formErrors=!0};var e=function(){};e()}angular.module("Songs").controller("CreateAccountCtrl",["$scope","$http","$cookieStore",CreateAccountCtrl]);
<<<<<<< HEAD
function FindHostCtrl(e,o,n,t,s){var a="https://thomasscully.com";e.modalInstance=null,e.animationsEnabled=!0,e.formErrors=!1,e.formErrorMessage="",e.currentId=null,e.hostId=null,o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},e.jukeboxes=[];var r=function(e){},l=function(o){null!=e.modalInstance&&(0==o.data?(e.formErrorMessage="Invalid password.",e.formErrors=!0):(isConnectedChecker=t.get("isConnectedToPlaylist"),(isConnectedChecker=!0)&&(t.put("jukeBoxid",e.currentId),t.put("hostid",e.hostId)),t.put("isConnectedToPlaylist",!0),t.put("connectPlaylistUserId",o.data),e.modalInstance.dismiss(),window.location="#/jukebox"))},i=function(e){},d=function(){o.get(a+"/playlists").success(function(o){e.jukeboxes=o,$(".spinner").addClass("hide")}).then(i,r)};e.open=function(o,t,s){e.hostId=t,e.currentId=s,e.modalInstance=n.open({animation:e.animationsEnabled,templateUrl:"templates/modalContent.html",size:o,scope:e,id:s})},e.submit=function(n,t,s){if(n){var i=e.currentId.toString();e.playlistname=s;var d={id:i,password:t.$modelValue};o.post(a+"/playlists/join",d).then(l,r)}else e.formErrors=!0,e.formErrorMessage="Enter Password"},d(),e.$on("hostSearchAttempted",function(o,n){var t=s.getAllJukeboxes();console.log(t),t.length>0?(e.jukeboxes=[],e.jukeboxes=t):(e.jukeboxes=[],$("#no-songs-message").removeClass("hide"))})}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore","searchApp",FindHostCtrl]);
function HostCtrl(e,t,o){var s="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},e.formErrors=!1,e.formErrorMessage="",e.userId=o.get("userId"),e.manageAccount=function(){window.location="#/manageaccount"},socket.on("message",function(e){console.log("Incoming message:",e)}),e.deletePlaylist=function(){var o=confirm("Are you sure you'd like to delete this playlist?");1==o&&t["delete"](s+"/playlists?id="+e.playlist_id).then(function(t){e.hasPlaylist=!1,a(e.playlist_id)},function(e){console.log("Server did not successfully complete request.")})},e.submit=function(o){if(o){var a={user__account:e.userId,playlist_name:e.loginDetails.playlist_name,description:e.loginDetails.description,password:e.loginDetails.password};t.post(s+"/playlists",a).then(function(t){console.log(t),e.hasPlaylist=!0,e.playlist_name=a.playlist_name,e.playlist_id=t.data,n(t.data)},function(e){console.log("Server did not successfully complete request.")})}else e.formErrors=!0,e.formErrorMessage="There was a problem with your input. Please try again."};var n=function(e){console.log("adding "+e),socket.emit("createRoom",e)},a=function(e){console.log("removing "+e),socket.emit("removeRoom",e)},i=function(e,t){for(var o=0,s=e.length;s>o;o+=1)if(e[o].id===t)return e[o]},l=function(t){""==t.data?e.hasPlaylist=!1:(e.hasPlaylist=!0,e.playlist_id=t.data.id,e.playlist_name=t.data.playlist_name,e.description=t.data.description,e.password=t.data.password),$(".spinner").addClass("hide"),$(".hostContainer").removeClass("hide")},r=function(t){var s=o.get("userId"),n=i(t.data,s);e.businessName=n.business},c=function(e){console.log("Something went wrong.")},d=function(){o.get("isLoggedIn")||(window.location="#/login"),t.get(s+"/playlists?account__id="+o.get("userId")).then(l,c),t.get(s+"/accounts?account__id="+o.get("userId")).then(r,c)};d()}angular.module("Songs").controller("HostCtrl",["$scope","$http","$cookieStore",HostCtrl]);
function JukeboxCtrl(o,e,t,n){var s="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var a=t.get("hostid");o.businessName,o.playlistName,o.upvote=function(o){var n=t.get("haveVotedSongs");n.push(o),t.put("haveVotedSongs",n),i();var a={action:"up",id:o};e.put(s+"/toggle/song/vote",a).success(function(e){var t=$("#songVoteCount_"+o),n=t.html();n++,t.html(n)}).error(function(o){console.log(o)})},o.downvote=function(o){var n=t.get("haveVotedSongs");n.push(o),t.put("haveVotedSongs",n),i();var a={action:"down",id:o};e.put(s+"/toggle/song/vote",a).success(function(e){var t=$("#songVoteCount_"+o),n=t.html();n--,t.html(n)}).error(function(o){console.log(o)})};var i=function(){for(var o=t.get("haveVotedSongs"),e=0;e<o.length;e++)$("#hasNotVoted_"+o[e]).html('<br><h3><span class="glyphicon glyphicon-ok" aria-hidden="true">');$(".spinner").addClass("hide"),$("#songList").removeClass("hide")},c=function(e){e.data.songs.length>0?o.songs=e.data.songs:$("#no-songs-message").removeClass("hide")},l=function(o){console.log("Error:"),console.log(o)},g=function(o){console.log("joining "+o),socket.emit("joinRoom",o)},u=function(){$(".spinner").removeClass("hide"),void 0!=t.get("isConnectedToPlaylist")&&t.get("isConnectedToPlaylist")||(window.location="#/findhost"),void 0!=t.get("haveVotedSongs")&&t.get("haveVotedSongs")||(o.hasVoted=[],t.put("haveVotedSongs",o.hasVoted)),e.get(s+"/accounts?account__id="+a).success(function(e){o.businessName=e[0]}).then(r,l),e.get(s+"/playlists?account__id="+a).success(function(e){o.playlistName=e[0]}).then(r,l),o.getFreshSongs(),g(t.get("connectPlaylistUserId"))};o.getFreshSongs=function(){$(".spinner").removeClass("hide"),e.get(s+"/songs/active?user_account_id="+t.get("connectPlaylistUserId")).then(c,l),$("#songList").addClass("hide"),setTimeout(i,1500)};var l=function(o){console.log("failure"),console.log(o)},r=function(o){};u()}var app=angular.module("Songs");app.controller("JukeboxCtrl",["$scope","$http","$cookieStore","$timeout",JukeboxCtrl]);
function LibraryCtrl(n,t,e,o){var s="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},n.addSongToJukebox=function(n){var e=$("#increaseButtonInner_"+n);e.html('<img src="img/default.gif" height="9px" width="9px" />'),e.addClass("disabled");var o={action:"in",id:n};t.put(s+"/toggle/song",o).success(function(t){$("#increaseButton_"+n).html('<br><button disabled type="button" id="increaseButton_{{song.id}}" class="btn btn-warning">+</button>')}).error(function(n){console.log(n)})};var i=function(t){$(".spinner").addClass("hide"),t.data.songs.length>0?n.songs=t.data.songs:$("#no-songs-message").removeClass("hide")},a=function(n){},r=function(){$(".spinner").removeClass("hide"),void 0!=e.get("isConnectedToPlaylist")&&e.get("isConnectedToPlaylist")?t.get(s+"/songs?user_account_id="+e.get("connectPlaylistUserId")).then(i,a):window.location="#/findhost"};r(),n.$on("searchAttempted",function(t,e){var s=o.getAllSongs();s.length>0?(n.songs=[],n.songs=s):(n.songs=[],$("#no-songs-message").removeClass("hide"))})}angular.module("Songs").controller("LibraryCtrl",["$scope","$http","$cookieStore","searchApp",LibraryCtrl]);
function LoginCtrl(o,r,e){var n="https://thomasscully.com";r.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.formErrors=!1,o.formErrorMessage="",o.submit=function(e){e?r.post(n+"/accounts/login",o.loginDetails).then(t,a):(o.formErrors=!0,o.formErrorMessage="Invalid username / password.")};var t=function(r){r.data?(e.put("isLoggedIn",!0),e.put("userId",r.data),window.location="#/host"):(o.formErrorMessage="Invalid username / password combination.",o.formErrors=!0)},a=function(r){o.formErrorMessage="Server not responding. Please try again later.",o.formErrors=!0},s=function(o,r){r||(r=window.location.href),r=r.toLowerCase(),o=o.replace(/[\[\]]/g,"\\$&").toLowerCase();var e=new RegExp("[?&]"+o+"(=([^&#]*)|&|#|$)"),n=e.exec(r);return n?n[2]?decodeURIComponent(n[2].replace(/\+/g," ")):"":null},i=function(){e.get("isLoggedIn")&&(window.location="#/host");var r=s("account_creation");r&&(o.accountCreated=!0)};i()}angular.module("Songs").controller("LoginCtrl",["$scope","$http","$cookieStore",LoginCtrl]);
function ManageAccountCtrl(n,o,t){o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},n.cancel=function(){window.location="#/host"},n.saveChanges=function(){};var e=function(){t.get("isLoggedIn")||(window.location="#/login")};e()}angular.module("Songs").controller("ManageAccountCtrl",["$scope","$http","$cookieStore",ManageAccountCtrl]);
function ManageJukeboxCtrl(t,e,n){var o="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},t.cancel=function(){window.location="#/host"},t.saveChanges=function(){};var a=[],s=[],c=[],l=[],r=[],u=[],d=[],g=[],f=function(){s=[],c=[],l=[],r=[],u=[],d=[]};t.upload=function(){document.getElementById("upload").disabled=!0,f(),h()};var h=function(){for(i=0;i<a.length;i++){var t=document.createElement("audio");t.setAttribute("id",i);var e=URL.createObjectURL(a[i]);u[i]=e,t.setAttribute("src",e),t.load(),t.oncanplaythrough=function(){r[this.id]=this.duration,m(this.id,b)}}},m=function(t,e){var n=a[t];new jsmediatags.Reader(n).setTagsToRead(["title","album","artist"]).read({onSuccess:function(n){s[t]=n.tags.title,c[t]=n.tags.artist,l[t]=n.tags.album,e(t)},onError:function(t){console.log(t)}})},b=function(t){d.push({song_title:s[t],song_artist:c[t],song_album:l[t],song_length:r[t],location_in_filesystem:u[t]}),g[t]=!0,v(),v()&&p()},p=function(){var t={user_account_id:2,number_of_songs:d.length,songs:d};e.post(o+"/songs",t).then(successCallback,errorCallback),document.getElementById("fileinput").value="",a=[]},v=function(){for(i=0;i<g.length;i++)if(!g[i])return!1;return!0};successCallback=function(t){},errorCallback=function(t){console.dir(t)};var k=document.getElementById("fileinput");k.addEventListener("change",function(t){for(a=[],g=[],i=0;i<t.target.files.length;i++){var e=t.target.files[i];a.push(e),g[i]=!1}document.getElementById("upload").disabled=!1},!1)}angular.module("Songs").controller("ManageJukeboxCtrl",["$scope","$http","$cookieStore",ManageJukeboxCtrl]);
function MasterCtrl(t,e,o){var n=992;t.greeting="Hola!",t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(o,g){o>=n?angular.isDefined(e.get("toggle"))?t.toggle=e.get("toggle")?!0:!1:t.toggle=!0:t.toggle=!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,e.put("toggle",t.toggle)},window.onresize=function(){t.$apply()},t.logout=function(){e.put("isLoggedIn",!1)},t.$on("$locationChangeStart",function(o){t.isLoggedIn=e.get("isLoggedIn"),void 0!=e.get("isConnectedToPlaylist")&&e.get("isConnectedToPlaylist")?t.isConnectedToPlaylist=!0:t.isConnectedToPlaylist=!1}),$(".nav a").on("click",function(){$(".navbar-toggle").click()}),t.search=function(t){var n=e.get("connectPlaylistUserId");o.findWhatToSearch(n,t)}}angular.module("Songs").controller("MasterCtrl",["$scope","$cookieStore","searchApp",MasterCtrl]);
=======
function FindHostCtrl(o,n,e,t){var s="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,o.hostId=null,n.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var r=function(o){console.log("failure"),console.log(o)},a=function(n){null!=o.modalInstance&&(0==n.data?(o.formErrorMessage="Invalid password.",o.formErrors=!0):(isConnectedChecker=t.get("isConnectedToPlaylist"),(isConnectedChecker=!0)&&(t.put("jukeBoxid",o.currentId),t.put("hostid",o.hostId)),t.put("isConnectedToPlaylist",!0),t.put("connectPlaylistUserId",n.data),o.modalInstance.dismiss(),window.location="#/jukebox"))},l=function(o){},i=function(){n.get(s+"/playlists").success(function(n){o.jukeboxes=n,$(".spinner").addClass("hide")}).then(l,r)};o.open=function(n,t,s){o.hostId=t,o.currentId=s,o.modalInstance=e.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:n,scope:o,id:s})},o.submit=function(e,t,l){if(e){var i=o.currentId.toString();o.playlistname=l;var d={id:i,password:t.$modelValue};n.post(s+"/playlists/join",d).then(a,r)}else o.formErrors=!0,o.formErrorMessage="Enter Password"},i()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
function HostCtrl(e,t,o){var s="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},e.formErrors=!1,e.formErrorMessage="",e.userId=o.get("userId"),e.manageAccount=function(){window.location="#/manageaccount"},socket.on("message",function(e){console.log("Incoming message:",e)}),e.deletePlaylist=function(){var o=confirm("Are you sure you'd like to delete this playlist?");1==o&&t["delete"](s+"/playlists?id="+e.playlist_id).then(function(t){e.hasPlaylist=!1,a(e.playlist_id)},function(e){console.log("Server did not successfully complete request.")})},e.submit=function(o){if(o){var a={user__account:e.userId,playlist_name:e.loginDetails.playlist_name,description:e.loginDetails.description,password:e.loginDetails.password};t.post(s+"/playlists",a).then(function(t){console.log(t),e.hasPlaylist=!0,e.playlist_name=a.playlist_name,e.playlist_id=t.data,n(t.data)},function(e){console.log("Server did not successfully complete request.")})}else e.formErrors=!0,e.formErrorMessage="There was a problem with your input. Please try again."};var n=function(e){console.log("adding "+e),socket.emit("createRoom",e)},a=function(e){console.log("removing "+e),socket.emit("removeRoom",e)},i=function(e,t){for(var o=0,s=e.length;s>o;o+=1)if(e[o].id===t)return e[o]},l=function(t){""==t.data?e.hasPlaylist=!1:(e.hasPlaylist=!0,e.playlist_id=t.data.id,e.playlist_name=t.data.playlist_name,e.description=t.data.description,e.password=t.data.password),$(".spinner").addClass("hide"),$(".hostContainer").removeClass("hide")},r=function(t){var s=o.get("userId"),n=i(t.data,s);e.businessName=n.business},c=function(e){console.log("Something went wrong.")},d=function(){o.get("isLoggedIn")||(window.location="#/login"),t.get(s+"/playlists?account__id="+o.get("userId")).then(l,c),t.get(s+"/accounts?account__id="+o.get("userId")).then(r,c)};d()}angular.module("Songs").controller("HostCtrl",["$scope","$http","$cookieStore",HostCtrl]);
function JukeboxCtrl(o,e,t,n){var s="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var a=t.get("hostid");o.businessName,o.playlistName,o.upvote=function(o){var n=t.get("haveVotedSongs");n.push(o),t.put("haveVotedSongs",n),i();var a={action:"up",id:o};e.put(s+"/toggle/song/vote",a).success(function(e){var t=$("#songVoteCount_"+o),n=t.html();n++,t.html(n)}).error(function(o){console.log(o)})},o.downvote=function(o){var n=t.get("haveVotedSongs");n.push(o),t.put("haveVotedSongs",n),i();var a={action:"down",id:o};e.put(s+"/toggle/song/vote",a).success(function(e){var t=$("#songVoteCount_"+o),n=t.html();n--,t.html(n)}).error(function(o){console.log(o)})};var i=function(){for(var o=t.get("haveVotedSongs"),e=0;e<o.length;e++)$("#hasNotVoted_"+o[e]).html('<br><h3><span class="glyphicon glyphicon-ok" aria-hidden="true">');$(".spinner").addClass("hide"),$("#songList").removeClass("hide")},c=function(e){e.data.songs.length>0?o.songs=e.data.songs:$("#no-songs-message").removeClass("hide")},l=function(o){console.log("Error:"),console.log(o)},g=function(o){console.log("joining "+o),socket.emit("joinRoom",o)},u=function(){$(".spinner").removeClass("hide"),void 0!=t.get("isConnectedToPlaylist")&&t.get("isConnectedToPlaylist")||(window.location="#/findhost"),void 0!=t.get("haveVotedSongs")&&t.get("haveVotedSongs")||(o.hasVoted=[],t.put("haveVotedSongs",o.hasVoted)),e.get(s+"/accounts?account__id="+a).success(function(e){o.businessName=e[0]}).then(r,l),e.get(s+"/playlists?account__id="+a).success(function(e){o.playlistName=e[0]}).then(r,l),o.getFreshSongs(),g(t.get("connectPlaylistUserId"))};o.getFreshSongs=function(){$(".spinner").removeClass("hide"),e.get(s+"/songs/active?user_account_id="+t.get("connectPlaylistUserId")).then(c,l),$("#songList").addClass("hide"),setTimeout(i,1500)};var l=function(o){console.log("failure"),console.log(o)},r=function(o){};u()}var app=angular.module("Songs");app.controller("JukeboxCtrl",["$scope","$http","$cookieStore","$timeout",JukeboxCtrl]);
function LibraryCtrl(n,o,t,e){var s="https://thomasscully.com";o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},n.addSongToJukebox=function(n){var t=$("#increaseButtonInner_"+n);t.html('<img src="img/default.gif" height="9px" width="9px" />'),t.addClass("disabled");var e={action:"in",id:n};o.put(s+"/toggle/song",e).success(function(o){$("#increaseButton_"+n).html('<br><button disabled type="button" id="increaseButton_{{song.id}}" class="btn btn-warning">+</button>')}).error(function(n){console.log(n)})};var i=function(o){$(".spinner").addClass("hide"),o.data.songs.length>0?n.songs=o.data.songs:$("#no-songs-message").removeClass("hide")},a=function(n){console.log("Error:"),console.log(n)},r=function(){$(".spinner").removeClass("hide"),void 0!=t.get("isConnectedToPlaylist")&&t.get("isConnectedToPlaylist")?o.get(s+"/songs?user_account_id="+t.get("connectPlaylistUserId")).then(i,a):window.location="#/findhost"};r()}angular.module("Songs").controller("LibraryCtrl",["$scope","$http","$cookieStore","$window",LibraryCtrl]);
function LoginCtrl(o,r,e){var n="https://thomasscully.com";r.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.formErrors=!1,o.formErrorMessage="",o.submit=function(e){e?r.post(n+"/accounts/login",o.loginDetails).then(t,a):(o.formErrors=!0,o.formErrorMessage="Invalid username / password.")};var t=function(r){r.data?(e.put("isLoggedIn",!0),e.put("userId",r.data),window.location="#/host"):(o.formErrorMessage="Invalid username / password combination.",o.formErrors=!0)},a=function(r){o.formErrorMessage="Server not responding. Please try again later.",o.formErrors=!0},s=function(o,r){r||(r=window.location.href),r=r.toLowerCase(),o=o.replace(/[\[\]]/g,"\\$&").toLowerCase();var e=new RegExp("[?&]"+o+"(=([^&#]*)|&|#|$)"),n=e.exec(r);return n?n[2]?decodeURIComponent(n[2].replace(/\+/g," ")):"":null},i=function(){e.get("isLoggedIn")&&(window.location="#/host");var r=s("account_creation");r&&(o.accountCreated=!0)};i()}angular.module("Songs").controller("LoginCtrl",["$scope","$http","$cookieStore",LoginCtrl]);
function ManageAccountCtrl(n,o,t){o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},n.cancel=function(){window.location="#/host"},n.saveChanges=function(){};var e=function(){t.get("isLoggedIn")||(window.location="#/login")};e()}angular.module("Songs").controller("ManageAccountCtrl",["$scope","$http","$cookieStore",ManageAccountCtrl]);
function ManageJukeboxCtrl(t,e,n){var o="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},t.cancel=function(){window.location="#/host"},t.saveChanges=function(){};var a=[],s=[],c=[],l=[],r=[],u=[],d=[],g=[],f=function(){s=[],c=[],l=[],r=[],u=[],d=[]};t.upload=function(){document.getElementById("upload").disabled=!0,f(),h()};var h=function(){for(i=0;i<a.length;i++){var t=document.createElement("audio");t.setAttribute("id",i);var e=URL.createObjectURL(a[i]);u[i]=e,t.setAttribute("src",e),t.load(),t.oncanplaythrough=function(){r[this.id]=this.duration,m(this.id,b)}}},m=function(t,e){var n=a[t];new jsmediatags.Reader(n).setTagsToRead(["title","album","artist"]).read({onSuccess:function(n){s[t]=n.tags.title,c[t]=n.tags.artist,l[t]=n.tags.album,e(t)},onError:function(t){console.log(t)}})},b=function(t){d.push({song_title:s[t],song_artist:c[t],song_album:l[t],song_length:r[t],location_in_filesystem:u[t]}),g[t]=!0,v(),v()&&p()},p=function(){var t={user_account_id:2,number_of_songs:d.length,songs:d};e.post(o+"/songs",t).then(successCallback,errorCallback),document.getElementById("fileinput").value="",a=[]},v=function(){for(i=0;i<g.length;i++)if(!g[i])return!1;return!0};successCallback=function(t){},errorCallback=function(t){console.dir(t)};var k=document.getElementById("fileinput");k.addEventListener("change",function(t){for(a=[],g=[],i=0;i<t.target.files.length;i++){var e=t.target.files[i];a.push(e),g[i]=!1}document.getElementById("upload").disabled=!1},!1)}angular.module("Songs").controller("ManageJukeboxCtrl",["$scope","$http","$cookieStore",ManageJukeboxCtrl]);
function MasterCtrl(t,o){var e=992;t.greeting="Hola!",t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(n,g){n>=e?angular.isDefined(o.get("toggle"))?t.toggle=!!o.get("toggle"):t.toggle=!0:t.toggle=!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,o.put("toggle",t.toggle)},window.onresize=function(){t.$apply()},t.logout=function(){o.put("isLoggedIn",!1)},t.$on("$locationChangeStart",function(e){t.isLoggedIn=o.get("isLoggedIn"),void 0!=o.get("isConnectedToPlaylist")&&o.get("isConnectedToPlaylist")?t.isConnectedToPlaylist=!0:t.isConnectedToPlaylist=!1}),$(".nav a").on("click",function(){$(".navbar-toggle").click()})}angular.module("Songs").controller("MasterCtrl",["$scope","$cookieStore",MasterCtrl]);
>>>>>>> refs/remotes/origin/master
function rdLoading(){var d={restrict:"AE",template:'<div class="loading"><div class="double-bounce1"></div><div class="double-bounce2"></div></div>'};return d}angular.module("Songs").directive("rdLoading",rdLoading);
function rdWidgetBody(){var d={requires:"^rdWidget",scope:{loading:"@?",classes:"@?"},transclude:!0,template:'<div class="widget-body" ng-class="classes"><rd-loading ng-show="loading"></rd-loading><div ng-hide="loading" class="widget-content" ng-transclude></div></div>',restrict:"E"};return d}angular.module("Songs").directive("rdWidgetBody",rdWidgetBody);
function rdWidgetFooter(){var e={requires:"^rdWidget",transclude:!0,template:'<div class="widget-footer" ng-transclude></div>',restrict:"E"};return e}angular.module("Songs").directive("rdWidgetFooter",rdWidgetFooter);
function rdWidgetTitle(){var i={requires:"^rdWidget",scope:{title:"@",icon:"@"},transclude:!0,template:'<div class="widget-header"><div class="row"><div class="pull-left"><i class="fa" ng-class="icon"></i> {{title}} </div><div class="pull-right col-xs-6 col-sm-4" ng-transclude></div></div></div>',restrict:"E"};return i}angular.module("Songs").directive("rdWidgetHeader",rdWidgetTitle);
function rdWidget(){var d={transclude:!0,template:'<div class="widget" ng-transclude></div>',restrict:"EA"};return d}angular.module("Songs").directive("rdWidget",rdWidget);
<<<<<<< HEAD
function searchApp(e,o,t){var a="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var n=[],s=[],r=function(o){o.data.songs.length>0&&(n=[],o.data.songs.forEach(function(o){o.song_title.toLowerCase().search(e.searchFor.toLowerCase())>-1?n.push(o):console.log("Song is not going to be returned")})),e.$broadcast("searchAttempted",{myParam:e.songs})},c=function(e){},h=function(o){o.data.length>0&&(s=[],o.data.forEach(function(o){o.playlist_name.toLowerCase().search(e.searchFor.toLowerCase())>-1?s.push(o):console.log("Host is not going to be returned")})),e.$broadcast("hostSearchAttempted",{myParam:e.songs})};return{findWhatToSearch:function(n,s){e.searchFor=s;var i=o.absUrl();i.search("library")>-1||i.search("jukebox")>-1?t.get(a+"/songs?user_account_id="+n).then(r,c):i.search("findhost")&&t.get(a+"/playlists").then(h,c)},getAllSongs:function(){return n},getAllJukeboxes:function(){return s}}}angular.module("Songs").service("searchApp",["$rootScope","$location","$http",searchApp]);
