...
function ManageJukeboxCtrl(t,e,n){t.cancel=function(){window.location="#/host"},t.saveChanges=function(){};var o=[],a=[],u=[],l=[],r=[],c=[],d=[],s=function(){a=[],u=[],l=[],r=[],c=[]};t.upload=function(){document.getElementById("upload").disabled=!0,s(),g()};var g=function(){for(i=0;i<o.length;i++){var t=document.createElement("audio");t.setAttribute("id",i),t.setAttribute("src",URL.createObjectURL(o[i])),t.load(),t.oncanplaythrough=function(){a[this.id]=this.duration,f(this.id,m)}}},f=function(t,e){var n=o[t];new jsmediatags.Reader(n).setTagsToRead(["title","album","artist"]).read({onSuccess:function(n){u[t]=n.tags.title,l[t]=n.tags.album,r[t]=n.tags.artist,e(t)},onError:function(t){console.log(t)}})},m=function(t){c[t]={title:u[t],atrist:r[t],album:l[t],duration:a[t]},d[t]=!0,b(),b()&&h()},h=function(){console.log(c),document.getElementById("fileinput").value="",o=[],document.getElementById("upload").disabled=!1},b=function(){for(i=0;i<d.length;i++)if(!d[i])return!1;return!0},p=document.getElementById("fileinput");p.addEventListener("change",function(t){o=[],d=[];for(i=0;i<t.target.files.length;i++){var e=t.target.files[i];o.push(e),d[i]=!1}document.getElementById("upload").disabled=!1},!1)}angular.module("Songs").controller("ManageJukeboxCtrl",["$scope","$http","$cookieStore",ManageJukeboxCtrl]);
