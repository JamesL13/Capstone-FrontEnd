...
function searchApp(o,e,n){var t="https://thomasscully.com";n.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var s=[],a=function(e){e.data.songs.length>0&&e.data.songs.forEach(function(e){e.song_title.search(o.searchFor)>-1?(s.push(e),o.$broadcast("searchAttempted",{myParam:o.songs})):console.log("Song is not going to be returned")})},r=function(o){console.log("Error:"),console.log(o)},c=function(o){console.log(o)};return{findWhatToSearch:function(s,l){o.searchFor=l;var h=e.absUrl();h.search("library")>-1||h.search("jukebox")>-1?n.get(t+"/songs?user_account_id="+s).then(a,r):h.search("findhost")?n.get(t+"/playlists").then(c,r):alert("Hi")},getAllSongs:function(){return s}}}angular.module("Songs").service("searchApp",["$rootScope","$location","$http",searchApp]);
