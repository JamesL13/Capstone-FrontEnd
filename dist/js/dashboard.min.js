...
function CreateAccountCtrl(r,o,t){var a="https://thomasscully.com";o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},r.formErrors=!1,r.formErrorMessage="",r.submit=function(t){t?(r.formErrors=!1,o.post(a+"/accounts",r.accountInfo).then(successCallback,errorCallback)):(r.formErrors=!0,r.formErrorMessage="Invalid form input. Please try again.")},successCallback=function(o){console.log(o),"Email already in use.  Cannot create account."==o.data?(r.formErrorMessage=o.data,r.formErrors=!0):window.location="#/login?account_creation=true"},errorCallback=function(o){r.formErrors=!0};var e=function(){};e()}angular.module("Songs").controller("CreateAccountCtrl",["$scope","$http","$cookieStore",CreateAccountCtrl]);
function FindHostCtrl(o,t,e,n){var s="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,o.hostId=null,t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var r=function(o){console.log("failure"),console.log(o)},a=function(t){null!=o.modalInstance&&(0==t.data?(o.formErrorMessage="Invalid password.",o.formErrors=!0):(isConnectedChecker=n.get("isConnectedToPlaylist"),(isConnectedChecker=!0)&&(n.put("jukeBoxid",o.currentId),n.put("hostid",o.hostId)),socket.emit("room",o.playlistname),n.put("isConnectedToPlaylist",!0),n.put("connectPlaylistUserId",t.data),o.modalInstance.dismiss(),window.location="#/jukebox"))},l=function(o){},i=function(){t.get(s+"/playlists").success(function(t){o.jukeboxes=t}).then(l,r)};o.open=function(t,n,s){o.hostId=n,o.currentId=s,o.modalInstance=e.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:t,scope:o,id:s})},o.submit=function(e,n,l){if(e){var i=o.currentId.toString();o.playlistname=l;var c={id:i,password:n.$modelValue};t.post(s+"/playlists/join",c).then(a,r)}else o.formErrors=!0,o.formErrorMessage="Enter Password"},i()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
...
function JukeboxCtrl(t,o,e){var n="https://thomasscully.com";o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var s=e.get("hostid");t.businessName,t.playlistName;var c=function(){void 0!=e.get("isConnectedToPlaylist")&&e.get("isConnectedToPlaylist")||(window.location="#/findhost"),o.get(n+"/accounts?account__id="+s).success(function(o){console.log(o),t.businessName=o[0]}).then(a,i),o.get(n+"/playlists?account__id="+s).success(function(o){t.playlistName=o[0]}).then(a,i)},i=function(t){},a=function(t){};c()}angular.module("Songs").controller("JukeboxCtrl",["$scope","$http","$cookieStore",JukeboxCtrl]);
function LibraryCtrl(o,t,n){var e="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var s=function(t){console.log(t),o.songs=t.data.songs},c=function(o){},l=function(){void 0!=n.get("isConnectedToPlaylist")&&n.get("isConnectedToPlaylist")?(console.log("connectPlaylistUserId: "+n.get("connectPlaylistUserId")),t.get(e+"/songs?user_account_id="+n.get("connectPlaylistUserId")).then(s,c)):window.location="#/findhost"};l()}angular.module("Songs").controller("LibraryCtrl",["$scope","$http","$cookieStore",LibraryCtrl]);
...
function ManageJukeboxCtrl(t,e,n){var o="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},t.cancel=function(){window.location="#/host"},t.saveChanges=function(){};var a=[],s=[],l=[],c=[],r=[],u=[],g=[],d=[],f=function(){s=[],l=[],c=[],r=[],u=[],g=[]};t.upload=function(){document.getElementById("upload").disabled=!0,f(),h()};var h=function(){for(i=0;i<a.length;i++){var t=document.createElement("audio");t.setAttribute("id",i);var e=URL.createObjectURL(a[i]);u[i]=e,t.setAttribute("src",e),t.load(),t.oncanplaythrough=function(){r[this.id]=this.duration,m(this.id,b)}}},m=function(t,e){var n=a[t];new jsmediatags.Reader(n).setTagsToRead(["title","album","artist"]).read({onSuccess:function(n){s[t]=n.tags.title,l[t]=n.tags.artist,c[t]=n.tags.album,e(t)},onError:function(t){console.log(t)}})},b=function(t){g.push({song_title:s[t],song_artist:l[t],song_album:c[t],song_length:r[t],location_in_filesystem:u[t]}),d[t]=!0,v(),v()&&p()},p=function(){console.log(g);var t={user_account_id:2,number_of_songs:g.length,songs:g};console.log(t),e.post(o+"/songs",t).then(successCallback,errorCallback),document.getElementById("fileinput").value="",a=[]},v=function(){for(i=0;i<d.length;i++)if(!d[i])return!1;return!0};successCallback=function(t){console.log("SUCCESS: "+t)},errorCallback=function(t){console.dir(t)};var k=document.getElementById("fileinput");k.addEventListener("change",function(t){for(a=[],d=[],i=0;i<t.target.files.length;i++){var e=t.target.files[i];a.push(e),d[i]=!1}document.getElementById("upload").disabled=!1},!1)}angular.module("Songs").controller("ManageJukeboxCtrl",["$scope","$http","$cookieStore",ManageJukeboxCtrl]);
