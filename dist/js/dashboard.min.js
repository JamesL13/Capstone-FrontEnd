...
function FindHostCtrl(e,o,t,n,s){var a="https://thomasscully.com";e.modalInstance=null,e.animationsEnabled=!0,e.formErrors=!1,e.formErrorMessage="",e.currentId=null,e.hostId=null,o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},e.jukeboxes=[];var r=function(e){},l=function(o){null!=e.modalInstance&&(0==o.data?(e.formErrorMessage="Invalid password.",e.formErrors=!0):(isConnectedChecker=n.get("isConnectedToPlaylist"),(isConnectedChecker=!0)&&(n.put("jukeBoxid",e.currentId),n.put("hostid",e.hostId)),n.put("isConnectedToPlaylist",!0),n.put("connectPlaylistUserId",o.data),e.modalInstance.dismiss(),window.location="#/jukebox"))},i=function(e){},d=function(){o.get(a+"/playlists").success(function(o){e.jukeboxes=o,$(".spinner").addClass("hide")}).then(i,r)};e.open=function(o,n,s){e.hostId=n,e.currentId=s,e.modalInstance=t.open({animation:e.animationsEnabled,templateUrl:"templates/modalContent.html",size:o,scope:e,id:s})},e.submit=function(t,n,s){if(t){var i=e.currentId.toString();e.playlistname=s;var d={id:i,password:n.$modelValue};o.post(a+"/playlists/join",d).then(l,r)}else e.formErrors=!0,e.formErrorMessage="Enter Password"},d(),e.$on("hostSearchAttempted",function(o,t){var n=s.getAllJukeboxes();n.length>0?(e.jukeboxes=[],e.jukeboxes=n):(e.jukeboxes=[],$("#no-songs-message").removeClass("hide"))})}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore","searchApp",FindHostCtrl]);
function HostCtrl(t,e,s){var a="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},t.formErrors=!1,t.formErrorMessage="",t.userId=s.get("userId"),t.manageAccount=function(){window.location="#/manageaccount"},socket.on("message",function(t){}),t.deletePlaylist=function(){var s=confirm("Are you sure you'd like to delete this playlist?");1==s&&e["delete"](a+"/playlists?id="+t.playlist_id).then(function(e){t.hasPlaylist=!1,i(t.playlist_id)},function(t){})},t.submit=function(s){if(s){var i={user__account:t.userId,playlist_name:t.loginDetails.playlist_name,description:t.loginDetails.description,password:t.loginDetails.password};e.post(a+"/playlists",i).then(function(e){t.hasPlaylist=!0,t.playlist_name=i.playlist_name,t.playlist_id=e.data,o(e.data)},function(t){})}else t.formErrors=!0,t.formErrorMessage="There was a problem with your input. Please try again."};var o=function(t){socket.emit("createRoom",s.get("userId"))},i=function(t){socket.emit("removeRoom",s.get("userId"))},n=function(t,e){for(var s=0,a=t.length;a>s;s+=1)if(t[s].id===e)return t[s]},l=function(e){""==e.data?t.hasPlaylist=!1:(t.hasPlaylist=!0,t.playlist_id=e.data.id,t.playlist_name=e.data.playlist_name,t.description=e.data.description,t.password=e.data.password),$(".spinner").addClass("hide"),$(".hostContainer").removeClass("hide")},r=function(e){var a=s.get("userId"),o=n(e.data,a);t.businessName=o.business},c=function(t){},d=function(){s.get("isLoggedIn")||(window.location="#/login"),e.get(a+"/playlists?account__id="+s.get("userId")).then(l,c),e.get(a+"/accounts?account__id="+s.get("userId")).then(r,c)};d()}angular.module("Songs").controller("HostCtrl",["$scope","$http","$cookieStore",HostCtrl]);
function JukeboxCtrl(t,o,n,e){var s="https://thomasscully.com";o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var a=n.get("hostid");t.businessName,t.playlistName,t.upvote=function(t){var e=n.get("haveVotedSongs");e.push(t),n.put("haveVotedSongs",e),i();var a={action:"up",id:t};o.put(s+"/toggle/song/vote",a).success(function(o){var n=$("#songVoteCount_"+t),e=n.html();e++,n.html(e)}).error(function(t){})},t.downvote=function(t){var e=n.get("haveVotedSongs");e.push(t),n.put("haveVotedSongs",e),i();var a={action:"down",id:t};o.put(s+"/toggle/song/vote",a).success(function(o){var n=$("#songVoteCount_"+t),e=n.html();e--,n.html(e)}).error(function(t){})};var i=function(){for(var t=n.get("haveVotedSongs"),o=0;o<t.length;o++)$("#hasNotVoted_"+t[o]).html('<br><h3><span class="glyphicon glyphicon-ok" aria-hidden="true">');$(".spinner").addClass("hide"),$("#songList").removeClass("hide")},c=function(o){o.data.songs.length>0?t.songs=o.data.songs:$("#no-songs-message").removeClass("hide")},g=function(t){},u=function(t){socket.emit("joinRoom",n.get("connectPlaylistUserId"))},l=function(){$(".spinner").removeClass("hide"),void 0!=n.get("isConnectedToPlaylist")&&n.get("isConnectedToPlaylist")||(window.location="#/findhost"),void 0!=n.get("haveVotedSongs")&&n.get("haveVotedSongs")||(t.hasVoted=[],n.put("haveVotedSongs",t.hasVoted)),o.get(s+"/accounts?account__id="+a).success(function(o){t.businessName=o[0]}).then(r,g),o.get(s+"/playlists?account__id="+a).success(function(o){t.playlistName=o[0]}).then(r,g),o.get(s+"/songs/current_song").success(function(o){t.now_playing=o}),t.getFreshSongs(),u(n.get("connectPlaylistUserId"))};socket.on("newSongPlaying",function(o){t.now_playing.name=o.name,t.now_playing.artist=o.artist,t.now_playing.album=o.album}),t.getFreshSongs=function(){$(".spinner").removeClass("hide"),o.get(s+"/songs/active?user_account_id="+n.get("connectPlaylistUserId")).then(c,g),$("#songList").addClass("hide"),setTimeout(i,1500)};var g=function(t){},r=function(t){};l()}var app=angular.module("Songs");app.controller("JukeboxCtrl",["$scope","$http","$cookieStore","$timeout",JukeboxCtrl]);
function LibraryCtrl(n,t,e,s){var o="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},n.addSongToJukebox=function(n){var e=$("#increaseButtonInner_"+n);e.html('<img src="img/default.gif" height="9px" width="9px" />'),e.addClass("disabled");var s={action:"in",id:n};t.put(o+"/toggle/song",s).success(function(t){$("#increaseButton_"+n).html('<br><button disabled type="button" id="increaseButton_{{song.id}}" class="btn btn-warning">+</button>')}).error(function(n){})};var i=function(t){$(".spinner").addClass("hide"),t.data.songs.length>0?n.songs=t.data.songs:$("#no-songs-message").removeClass("hide")},a=function(n){},r=function(){$(".spinner").removeClass("hide"),void 0!=e.get("isConnectedToPlaylist")&&e.get("isConnectedToPlaylist")?t.get(o+"/songs?user_account_id="+e.get("connectPlaylistUserId")).then(i,a):window.location="#/findhost"};r(),n.$on("searchAttempted",function(t,e){var o=s.getAllSongs();o.length>0?(n.songs=[],n.songs=o):(n.songs=[],$("#no-songs-message").removeClass("hide"))})}angular.module("Songs").controller("LibraryCtrl",["$scope","$http","$cookieStore","searchApp",LibraryCtrl]);
...
function ManageJukeboxCtrl(t,e,n){var o="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},t.cancel=function(){window.location="#/host"},t.saveChanges=function(){};var a=[],s=[],c=[],u=[],l=[],r=[],d=[],g=[],f=function(){s=[],c=[],u=[],l=[],r=[],d=[]};t.upload=function(){document.getElementById("upload").disabled=!0,f(),h()};var h=function(){for(i=0;i<a.length;i++){var t=document.createElement("audio");t.setAttribute("id",i);var e=URL.createObjectURL(a[i]);r[i]=e,t.setAttribute("src",e),t.load(),t.oncanplaythrough=function(){l[this.id]=this.duration,m(this.id,b)}}},m=function(t,e){var n=a[t];new jsmediatags.Reader(n).setTagsToRead(["title","album","artist"]).read({onSuccess:function(n){s[t]=n.tags.title,c[t]=n.tags.artist,u[t]=n.tags.album,e(t)},onError:function(t){}})},b=function(t){d.push({song_title:s[t],song_artist:c[t],song_album:u[t],song_length:l[t],location_in_filesystem:r[t]}),g[t]=!0,v(),v()&&p()},p=function(){var t={user_account_id:2,number_of_songs:d.length,songs:d};e.post(o+"/songs",t).then(successCallback,errorCallback),document.getElementById("fileinput").value="",a=[]},v=function(){for(i=0;i<g.length;i++)if(!g[i])return!1;return!0};successCallback=function(t){},errorCallback=function(t){};var k=document.getElementById("fileinput");k.addEventListener("change",function(t){for(a=[],g=[],i=0;i<t.target.files.length;i++){var e=t.target.files[i];a.push(e),g[i]=!1}document.getElementById("upload").disabled=!1},!1)}angular.module("Songs").controller("ManageJukeboxCtrl",["$scope","$http","$cookieStore",ManageJukeboxCtrl]);
...
function searchApp(e,t,a){var o="https://thomasscully.com";a.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var s=[],n=[],r=function(t){t.data.songs.length>0&&(s=[],t.data.songs.forEach(function(t){t.song_title.toLowerCase().search(e.searchFor.toLowerCase())>-1&&s.push(t)})),e.$broadcast("searchAttempted",{myParam:e.songs})},c=function(e){},h=function(t){t.data.length>0&&(n=[],t.data.forEach(function(t){t.playlist_name.toLowerCase().search(e.searchFor.toLowerCase())>-1&&n.push(t)})),e.$broadcast("hostSearchAttempted",{myParam:e.songs})};return{findWhatToSearch:function(s,n){e.searchFor=n;var i=t.absUrl();i.search("library")>-1||i.search("jukebox")>-1?a.get(o+"/songs?user_account_id="+s).then(r,c):i.search("findhost")&&a.get(o+"/playlists").then(h,c)},getAllSongs:function(){return s},getAllJukeboxes:function(){return n}}}angular.module("Songs").service("searchApp",["$rootScope","$location","$http",searchApp]);
