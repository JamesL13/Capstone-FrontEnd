...
function FindHostCtrl(o,n,e){var t="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,n.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var s=function(n){1==n?($cookieStore.put("isConnected",!0),$cookieStore.put("jukeBoxid",o.currentId),null!=o.modalInstance&&o.modalInstance.$dismiss(connect)):(o.formErrorMessage="Invalid password.",o.formErrors=!0),null!=o.modalInstance&&o.modalInstance.$dismiss(connect)},r=function(o){console.log(o)},l=function(){n.get(t+"/playlists").success(function(n){o.jukeboxes=n}).then(s,r)};o.open=function(n,t){console.log(t),o.currentId=t,o.modalInstance=e.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:n})},o.submit=function(e){console.log("Here"),e?n.post(t+"/playlists/join",{id:o.currentId},o.connectDetails).then(s,r):(o.formErrors=!0,o.formErrorMessage="Invalid password.")},l()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
