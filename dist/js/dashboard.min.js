...
function FindHostCtrl(o,e,n,t){var s="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,o.hostId=null,e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var r=function(o){console.log("failure"),console.log(o)},a=function(e){null!=o.modalInstance&&(0==e.data?(o.formErrorMessage="Invalid password.",o.formErrors=!0):(isConnectedChecker=t.get("isConnectedToPlaylist"),(isConnectedChecker=!0)&&(t.put("jukeBoxid",o.currentId),t.put("hostid",o.hostId)),socket.emit("room",o.playlistname),t.put("isConnectedToPlaylist",!0),t.put("connectPlaylistUserId",e.data),o.modalInstance.dismiss(),window.location="#/jukebox"))},l=function(o){},i=function(){e.get(s+"/playlists").success(function(e){o.jukeboxes=e,$(".spinner").hide()}).then(l,r)};o.open=function(e,t,s){o.hostId=t,o.currentId=s,o.modalInstance=n.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:e,scope:o,id:s})},o.submit=function(n,t,l){if(n){var i=o.currentId.toString();o.playlistname=l;var c={id:i,password:t.$modelValue};e.post(s+"/playlists/join",c).then(a,r)}else o.formErrors=!0,o.formErrorMessage="Enter Password"},i()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
function HostCtrl(o,e,t){var s="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.formErrors=!1,o.formErrorMessage="",o.userId=t.get("userId"),o.manageAccount=function(){window.location="#/manageaccount"},socket.on("message",function(o){console.log("Incoming message:",o)}),o.deletePlaylist=function(){var t=confirm("Are you sure you'd like to delete this playlist?");1==t&&e["delete"](s+"/playlists?id="+o.playlist_id).then(function(o){location.reload()},function(o){console.log("Server did not successfully complete request.")})},o.submit=function(t){if(t){var n={user__account:o.userId,playlist_name:o.loginDetails.playlist_name,description:o.loginDetails.description,password:o.loginDetails.password};e.post(s+"/playlists",n).then(function(o){room=n.playlist_name,console.log("Client side - Room: "+room),socket.emit("room",room),location.reload()},function(o){console.log("Server did not successfully complete request.")})}else o.formErrors=!0,o.formErrorMessage="There was a problem with your input. Please try again."};var n=function(o,e){for(var t=0,s=o.length;s>t;t+=1)if(o[t].id===e)return o[t]},i=function(e){""==e.data?o.hasPlaylist=!1:(o.hasPlaylist=!0,o.playlist_id=e.data[0].id,o.playlist_name=e.data[0].playlist_name,o.description=e.data[0].description,o.password=e.data[0].password)},a=function(e){var s=t.get("userId"),i=n(e.data,s);o.businessName=i.business},l=function(o){console.log("Something went wrong.")},r=function(){t.get("isLoggedIn")||(window.location="#/login"),e.get(s+"/playlists?account__id="+t.get("userId")).then(i,l),e.get(s+"/accounts?account__id="+t.get("userId")).then(a,l)};r()}angular.module("Songs").controller("HostCtrl",["$scope","$http","$cookieStore",HostCtrl]);
function JukeboxCtrl(o,e,t,n){var s="https://thomasscully.com";e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"};var a=t.get("hostid");o.businessName,o.playlistName,o.upvote=function(o){var n=t.get("haveVotedSongs");n.push(o),t.put("haveVotedSongs",n),i();var a={action:"up",id:o};e.put(s+"/toggle/song/vote",a).success(function(e){var t=$("#songVoteCount_"+o),n=t.html();n++,t.html(n)}).error(function(o){console.log(o)})},o.downvote=function(o){var n=t.get("haveVotedSongs");n.push(o),t.put("haveVotedSongs",n),i();var a={action:"down",id:o};e.put(s+"/toggle/song/vote",a).success(function(e){var t=$("#songVoteCount_"+o),n=t.html();n--,t.html(n)}).error(function(o){console.log(o)})};var i=function(){for(var o=t.get("haveVotedSongs"),e=0;e<o.length;e++)$("#hasNotVoted_"+o[e]).addClass("hide"),$("#hasVoted_"+o[e]).removeClass("hide");$(".spinner").hide(),$("#songList").removeClass("hide")},c=function(e){e.data.songs.length>0?o.songs=e.data.songs:$("#no-songs-message").removeClass("hide")},g=function(o){console.log("Error:"),console.log(o)},l=function(){void 0!=t.get("isConnectedToPlaylist")&&t.get("isConnectedToPlaylist")||(window.location="#/findhost"),void 0!=t.get("haveVotedSongs")&&t.get("haveVotedSongs")||(o.hasVoted=[],t.put("haveVotedSongs",o.hasVoted)),e.get(s+"/accounts?account__id="+a).success(function(e){o.businessName=e[0]}).then(u,g),e.get(s+"/playlists?account__id="+a).success(function(e){o.playlistName=e[0]}).then(u,g),o.getFreshSongs()};o.getFreshSongs=function(){e.get(s+"/songs/active?user_account_id="+t.get("connectPlaylistUserId")).then(c,g),$(".spinner").show(),$("#songList").addClass("hide"),setTimeout(i,1500)};var g=function(o){console.log("failure"),console.log(o)},u=function(o){};l()}var app=angular.module("Songs");app.controller("JukeboxCtrl",["$scope","$http","$cookieStore","$timeout",JukeboxCtrl]);
function LibraryCtrl(n,o,t,e){var s="https://thomasscully.com";o.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},n.addSongToJukebox=function(n){var t=$("#increaseButtonInner_"+n);t.html('<img src="img/default.gif" height="9px" width="9px" />'),t.addClass("disabled");var e={action:"in",id:n};o.put(s+"/toggle/song",e).success(function(o){$("#increaseButton_"+n).html(' <button disabled type="button" id="increaseButton_{{song.id}}" class="btn btn-warning">+</button>')}).error(function(n){console.log(n)})};var i=function(o){$(".spinner").hide(),o.data.songs.length>0?n.songs=o.data.songs:$("#no-songs-message").removeClass("hide")},a=function(n){console.log("Error:"),console.log(n)},c=function(){void 0!=t.get("isConnectedToPlaylist")&&t.get("isConnectedToPlaylist")?o.get(s+"/songs?user_account_id="+t.get("connectPlaylistUserId")).then(i,a):window.location="#/findhost"};c()}angular.module("Songs").controller("LibraryCtrl",["$scope","$http","$cookieStore","$window",LibraryCtrl]);
...
function MasterCtrl(t,e){var o=992;t.greeting="Hola!",t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(g,n){g>=o?angular.isDefined(e.get("toggle"))?t.toggle=e.get("toggle")?!0:!1:t.toggle=!0:t.toggle=!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,e.put("toggle",t.toggle)},window.onresize=function(){t.$apply()},t.logout=function(){e.put("isLoggedIn",!1)},t.$on("$locationChangeStart",function(o){t.isLoggedIn=e.get("isLoggedIn"),void 0!=e.get("isConnectedToPlaylist")&&e.get("isConnectedToPlaylist")?t.isConnectedToPlaylist=!0:t.isConnectedToPlaylist=!1})}angular.module("Songs").controller("MasterCtrl",["$scope","$cookieStore",MasterCtrl]);
