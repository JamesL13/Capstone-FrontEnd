...
function FindHostCtrl(o,e,n,t){var s="https://thomasscully.com";o.modalInstance=null,o.animationsEnabled=!0,o.formErrors=!1,o.formErrorMessage="",o.currentId=null,e.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.jukeboxes=[];var r=function(o){console.log("failure"),console.log(o)},a=function(e){null!=o.modalInstance&&(0==e.data?(o.formErrorMessage="Invalid password.",o.formErrors=!0):(isConnectedChecker=t.get("isConnectedToPlaylist"),(isConnectedChecker=!0)&&(t.put("jukeBoxid",""),t.put("jukeBoxid",o.currentId)),t.put("isConnectedToPlaylist",!0),t.put("jukeBoxid",o.currentId),o.modalInstance.dismiss(),window.location="#/jukebox"))},l=function(o){},i=function(){e.get(s+"/playlists").success(function(e){o.jukeboxes=e}).then(l,r)};o.open=function(e,t){o.currentId=t,o.modalInstance=n.open({animation:o.animationsEnabled,templateUrl:"templates/modalContent.html",size:e,scope:o,id:t})},o.submit=function(n,t){if(n){var l={id:"51",password:t.$modelValue};e.post(s+"/playlists/join",l).then(a,r)}else o.formErrors=!0,o.formErrorMessage="Enter Password"},i()}angular.module("Songs").controller("FindHostCtrl",["$scope","$http","$uibModal","$cookieStore",FindHostCtrl]);
