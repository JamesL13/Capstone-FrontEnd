...
function HostCtrl(o,t,e){var a="https://thomasscully.com";t.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.formErrors=!1,o.formErrorMessage="",o.userId=e.get("userId"),o.manageAccount=function(){window.location="#/manageaccount"},o.manageJukebox=function(){window.location="#/managejukebox"},o.deletePlaylist=function(){var e=confirm("Are you sure you'd like to delete this playlist?");1==e&&t["delete"](a+"/playlists?id="+o.playlist_id).then(function(o){location.reload()},function(o){console.log("Server did not successfully complete request.")})},o.submit=function(e){if(e){var s={user__account:o.userId,playlist_name:o.loginDetails.playlist_name,description:o.loginDetails.description,password:o.loginDetails.password};t.post(a+"/playlists",s).then(function(o){location.reload()},function(o){console.log("Server did not successfully complete request.")})}else o.formErrors=!0,o.formErrorMessage="There was a problem with your input. Please try again."};var s=function(t){""==t.data?o.hasPlaylist=!1:(o.hasPlaylist=!0,o.playlist_id=t.data[0].id,o.playlist_name=t.data[0].playlist_name,o.description=t.data[0].description,o.password=t.data[0].password)},n=function(o){},i=function(){e.get("isLoggedIn")||(window.location="#/login"),t.get(a+"/playlists?account__id="+e.get("userId")).then(s,n)};i()}angular.module("Songs").controller("HostCtrl",["$scope","$http","$cookieStore",HostCtrl]);
function LoginCtrl(o,r,e){var n="https://thomasscully.com";r.defaults.headers.common={"secret-token":"aBcDeFgHiJkReturnOfTheSixToken666666",Accept:"application/json, text/plain, */*"},o.formErrors=!1,o.formErrorMessage="",o.submit=function(e){e?r.post(n+"/accounts/login",o.loginDetails).then(t,s):(o.formErrors=!0,o.formErrorMessage="Invalid username / password.")};var t=function(r){r.data?(e.put("isLoggedIn",!0),e.put("userId",r.data),window.location="#/host"):(o.formErrorMessage="Invalid username / password combination.",o.formErrors=!0)},s=function(r){o.formErrorMessage="Server not responding. Please try again later.",o.formErrors=!0}}angular.module("Songs").controller("LoginCtrl",["$scope","$http","$cookieStore",LoginCtrl]);
